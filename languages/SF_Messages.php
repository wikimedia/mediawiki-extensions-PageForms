...
$messages['pms'] = array(
	...
	'templates' => 'Stamp',
	'sf_templates_docu' => 'Ant la wiki a esisto jë stamp sota.',
	'sf_templates_definescat' => 'a definiss categorìa:',
	...
	'sf_createtemplate_fieldsdesc' => "Përché ij camp an sto stamp-sì a ciam pa pi nòm ëd camp, ansëriss mach l'ìndes ëd minca camp (për esempi 1, 2, 3, etc...) com ël nòm, nopà dël nòm ver.",
	'sf_createtemplate_fieldname' => 'Nòm camp:',
	'sf_createtemplate_displaylabel' => 'Mosta etichëtta:',
	...
	'sf_createtemplate_aggregationdesc' => "Për listé, su minca pàgina ch'a dòvra sto stamp-sì, tute le pàgine ch'a l'han na serta proprietà ch'a ponta a cola pàgina, spessìfica l'aproprià proprietà sota:",
	'sf_createtemplate_aggregationlabel' => 'Tìtol për lista:',
	'sf_createtemplate_outputformat' => "Formà d'output:",
	'sf_createtemplate_standardformat' => 'Stàndard',
	'sf_createtemplate_infoboxformat' => 'Infobox dla part drita',
	'sf_createtemplate_addfield' => 'Gionta camp',
	'sf_createtemplate_deletefield' => 'Scansela',
	'sf_createtemplate_addtemplatebeforesave' => "It deuve gionté almanch në stamp për sta forma-sì prima ch'it peusse salvela.",
	'forms' => 'Forme',
	'sf_forms_docu' => 'Le forme sota a esisto ant la wiki.',
	'createform' => 'Crea na forma',
	'sf_createform_nameinput' => 'Nòm forma',
	'sf_createform_nameinputdesc' => "(convension a l'é nominé la forma d'apress che lë stamp prinsipal a l'ha popolala):",
	'sf_createform_template' => 'Stamp:',
	'sf_createform_templatelabelinput' => 'Etichëtta stamp (opsional):',
	'sf_createform_allowmultiple' => 'Përmëtt istanse mùltiple (o gnun-e) dë sto stamp-sì ant la pàgina creà',
	'sf_createform_field' => 'Camp:',
	'sf_createform_fieldprop' => 'Sto camp-sì a definiss la proprietà $1, ëd sòrt $2.',
	'sf_createform_fieldproplist' => "Sto camp-s' a definiss na lista d'element ch'a l'han la proprietà $1, ëd sòrt $2.",
	'sf_createform_fieldpropunknowntype' => 'Sto camp-sì a definiss la proprietà $1, ëd sòrt pa spessificà.',
	'sf_createform_inputtype' => 'Tipo input:',
	'sf_createform_inputtypedefault' => '(default)',
	'sf_createform_formlabel' => 'Etichëtta forma:',
	'sf_createform_hidden' => 'Stërmà',
	'sf_createform_restricted' => 'Riservà (mach utent sysop a peulo modifichelo)',
	'sf_createform_mandatory' => 'Obligatòri',
	'sf_createform_removetemplate' => 'Gava stamp',
	'sf_createform_addtemplate' => 'Gionta stamp',
	'sf_createform_beforetemplate' => 'Stamp prima:',
	'sf_createform_atend' => 'A la fin',
	'sf_createform_add' => 'Gionta',
	'sf_createform_choosefield' => 'Sern un camp da gionté',
	'createcategory' => 'Crea na categorìa',
	'sf_createcategory_name' => 'Nòm categorìa:',
	'sf_createcategory_defaultform' => 'Forma default:',
	'sf_createcategory_makesubcategory' => "Fà vnì sta categorìa-sì na sotcategorìa ëd n'àutra categorìa (opsional):",
	'createclass' => 'Crea na class',
	'sf_createclass_docu' => 'Ansëriss sì tùit ij dat për creé le proprietà, stamp, forma e categorìa për na sìngola class. Për pi psion, dòvra le pàgine $1 anvece.',
	'sf_createclass_allowedvalues' => 'Valor përmëttù',
	'sf_createclass_listofvalues' => 'Lista ëd valor',
	'sf_createclass_leavefieldblank' => "Se ël nòm camp a l'é l'istess com ël nòm proprietà, it peule lasselo bianch.",
	'sf_createclass_missingvalues' => 'Pa tùit ij camp ciamà a son stàit ampinì.',
	'sf_createclass_success' => 'Proprietà, stamp, forma e categorìa a saran creà.',
	'addpage' => 'Gionta pàgina con forma',
	'sf_addpage_badform' => 'Eror: pa gnun-e pàgine forma trovà a $1',
	'sf_addpage_badtitle' => 'Eror: "$1" a l\'é un tìtol pa bon për na pàgina.',
	'sf_addpage_docu' => 'Ansëriss ël nòm ëd la pàgina ambelessì, da modifiché con la forma "$1".
Se sta pàgina-sì a esist già, it saras mandà a la frma për modifiché cola pàgina.
Dasnò, it saras mandà a la forma për gionté la pàgina.',
	'sf_addpage_noform_docu' => 'Ansëriss ël nòm ëd la pàgina ambelessì, e selession-a la forma për modifichela.
Se sta pàgina-sì a esist già, it saras mandà a la forma për modifiché cola pàgina.
Dasnò, it saras mandà a la forma për gionté la pàgina.',
	'addoreditdata' => 'Gionta o modìfica',
	'adddata' => 'Gionta dat',
	'sf_adddata_title' => 'Gionta $1: $2',
	'sf_adddata_badurl' => "Sta sì a l'é la pàgina për gionté dat. It deuve spessifiché sia un nòm ëd forma sia na pàgina target ant la URL;
A dovrìa smijé a 'Special:AddData?form=&lt;form name&gt;&target=&lt;target page&gt;', or  
'Special:AddData/&lt;form name&gt;/&lt;target page&gt;'.",
);
