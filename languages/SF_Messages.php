...
$messages['en'] = array(
	...
	'sf_createform_allowmultiple'        => 'Allow for multiple (as opposed to zero) instances of this template in the created page',
...
<code>$1</code> is the name of the category that this template adds pages to.',
	...
	'sf_createform_allowmultiple' => 'Used as label for checkbox in {{msg-mw|Createform}} form.',
...
$messages['de'] = array(
	...
	'sf_createform_allowmultiple' => 'Erlaube mehrere (im Gegensatz zu keine) Instanzen dieser Vorlage auf der erstellten Seite',
...
$messages['el'] = array(
	...
	'sf_forminputs_uploadable' => 'Τοποθέτηση συνδέσμου «Ανέβασμα αρχείου» δίπλα σε αυτό το πλαίσιο εισόδου δεδομένων',
	...
	'sf_forminputs_valuesfromconcept' => 'Μια σελίδα "έννοιας" του Semantic MediaWiki της οποίας οι σελίδες να είναι το σύνολο τιμών αυτής της εισόδου δεδομένων',
	...
	'sf_createform_allowmultiple' => 'Να επιτρέπονται πολλαπλές (ή μηδέν) παρουσίες αυτού του προτύπου στη δημιουργηθείσα σελίδα', # Fuzzy
...
$messages['fr'] = array(
	...
	'sf_createform_allowmultiple' => 'Permettre plusieurs (en opposition à zéro) instances de ce modèle dans la page créée',
...
$messages['gl'] = array(
	...
	'sf_createform_allowmultiple' => 'Permitir varias instancias (no canto de cero) deste modelo na páxina creada',
	'sf_createform_field' => 'Campo:',
...
$messages['it'] = array(
	...
	'sf_createform_allowmultiple' => 'Permetti multiple (nessuna) istanze di questo template nella pagina creata', # Fuzzy
	'sf_createform_field' => 'Campo:',
...
$messages['ja'] = array(
	...
	'sf_createform_allowmultiple' => '作成したページでこのテンプレートを 1 回以上使用できるようにする', # Fuzzy
...
$messages['nl'] = array(
	...
	'sf_createform_allowmultiple' => 'Meerdere (in tegenstelling tot geen) instanties van deze sjabloon toestaan op de gemaakte pagina',
	'sf_createform_field' => 'Veld:',
...
$messages['pms'] = array(
	...
	'sf-createproperty-with-name' => 'Crea propietà: $1',
	...
	'sf-createtemplate-with-name' => 'Crea stamp: $1',
	'sf_createtemplate_namelabel' => 'Nòm ëd lë stamp:',
	'sf_createtemplate_multipleinstance' => 'Sto stamp a peul esse anserì vàire vòte an sla pagina.',
	...
	'sf_forminputs_hideroot' => 'Stërma la categorìa genitris',
	'sf_forminputs_depth' => 'Ël nùmer ëd livej ëd categorìe da mosté inissialment',
	...
	'sf-createform-with-name' => 'Crea forma: $1',
	...
	'sf-createcategory-with-name' => 'Crea categorìa: $1',
	...
	'sf_createclass_nameinput' => 'Nòm formolari:',
...
'Special:FormEdit/<form name>/<nòm dla pàgina>'.",
	...
	'sf_formedit_mismatchedbrackets' => 'Avis: Sta pagina a conten dle paréntes grafe o quadrà ch\'a son pa sarà, parèj la pagina a sarà pa gestìa coretament dal formolari. Për piasì <a href="$1">coregg l\'eror ant ël test sorziss</a> prima d\'andé anans.',
	...
	'sf_autoedit_notargetspecified' => 'Gnun-e pagine destinassion specificà.',
	'sf_autoedit_invalidtargetspecified' => "La pagina destinassion specificà $1 a l'é pa bon-a.",
	'sf_autoedit_invalidform' => "$1 a l'é un formolari pa bon.",
	'sf_autoedit_redirectlimitexeeded' => "Ël lìmit màssim ëd rediression për ël formolari $1 a l'é stàit superà.",
	'sf_autoedit_invalidredirecttarget' => "$1 a l'é na destinassion ëd rediression pa bon-a për ël formolari $2.",
	'sf_autoedit_invalidpreloadspecified' => "La pagina ëd precariagi specificà $1 a l'é pa bon-a.",
	'sf_autoedit_redlinkexists' => '$1 a esist già.',
	'sf_autoedit_noformfound' => 'Gnun formolari specificà.',
	'sf_autoedit_toomanyformsfound' => 'Pi che un formolari disponìbil për pagina.',
	'sf_autoedit_readonly' => "Ël database a l'é al moment blocà për le modìfiche. Rason: $1",
	'sf_autoedit_nosemanticform' => 'As peul pa pijesse ël formolari $2 për la pagina $1. Varda [[{{#special:FormEdit}}/$2/$1]] për ij detaj.',
	'sf_autoedit_summary' => 'Modificà automaticament për la pagina $1.',
...
l'adrëssa a dovrìa esse com 'Special:RunQuery/<nom del formolari>'.",
	...
	'sf-preview-header' => 'Visualisassion formolari',
	'sf-preview-note' => "Sòn a l'é lòn che ël formolari a smijerà quans as dovrerà:",
	'sf-pageschemas-pagenameformula' => 'Formula dël nòm pagina:',
	'sf-pageschemas-createtitle' => 'Tìtol dël formolari për pagine neuve:',
	'sf-pageschemas-edittitle' => 'Tìtol dël formolari për pagine esistente:',
	'sf-pageschemas-inputtype' => "Sòrt d'anseriment (lassa bianch për amposté a predefinì):",
...
se na pàgina con col nòm a esist già, a sarà mandà a \'n formolari për modifiché cola pàgina.',
	...
	'right-createclass' => 'Creé neuve class semàntiche',
	'action-createclass' => 'creé neuve class semàntiche',
...
$messages['sv'] = array(
	...
	'sf_createtemplate_standardformat' => 'Tabell',
	'sf_createtemplate_infoboxformat' => 'Höger informationsruta',
