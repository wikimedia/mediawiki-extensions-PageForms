...
$messages['ru'] = array(
	...
	'sf_createclass_docu' => 'Введите все данные здесь для создание свойств, шаблона, формы и категории для одного класса. Для больших настроек, используйте вместо этого страницу $1.',
	...
	'sf_editdata_morethanoneform' => "'''Внимание:''' Больше, чем одна форма по умолчанию была определена для этой страницы.",
...
URL должен выглядеть так: «Special:RunQuery/&lt;form name&gt;».',
	...
	'sf_property_linkstoform' => 'Ссылки на страницы, которые используют форму $1.',
