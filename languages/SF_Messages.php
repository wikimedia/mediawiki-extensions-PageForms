...
the URL should look like "Special:RunQuery/<form name>".',
	...
	'sf_too_few_instances_error'         => 'There must be at least {{PLURAL:$1|one instance|$1 instances}} of this template.',
	'sf_too_many_instances_error'        => 'There must be no more than {{PLURAL:$1|one instance|$1 instances}} of this template.',
...
l'URL hauria de ser com 'Especial:RunQuery/<nom_formulari>'.",
	...
	'sf_too_few_instances_error' => "Ha d'haver-hi com a mínim $1 instàncies d'aquesta plantilla.", # Fuzzy
	'sf_too_many_instances_error' => "No ha d'haver-hi més de $1 instàncies d'aquesta plantilla.", # Fuzzy
...
$messages['el'] = array(
	...
	'sf_createform_before' => 'Πριν το πρότυπο:',
	'sf_createform_sectionlevel' => 'Επίπεδο ενότητας:',
	'sf_createform_sectionname' => 'Όνομα ενότητας',
	'sf_createform_additembeforesave' => 'Πρέπει να προσθέσετε τουλάχιστον ένα πρότυπο σε αυτήν τη φόρμα για να μπορείτε να την αποθηκεύσετε.',
...
Θα πρέπει να μοιάζει με 'Ειδικό:FormEdit?form=<όνομα φόρμας>&target=<σελίδα προορισμού>', ή  'Ειδικό:FormEdit/<όνομα φόρμας>/<σελίδα προορισμού>'.",
	...
	'sf_formedit_remove' => 'Αφαίρεση', # Fuzzy
...
quelque chose comme « Special:RunQuery/<nom du formulaire> ».',
	...
	'sf_too_many_instances_error' => 'Il ne doit pas y avoir plus de {{PLURAL:$1|une instance|$1 instances}} de ce modèle.',
...
o URL debe ser do tipo "Special:RunQuery/<nome do formulario>".',
	...
	'sf_too_few_instances_error' => 'Debe haber, polo menos, {{PLURAL:$1|unha instancia|$1 instancias}} deste modelo.',
	'sf_too_many_instances_error' => 'Non debe haber máis de {{PLURAL:$1|unha instancia|$1 instancias}} deste modelo.',
...
$messages['gu'] = array(
	...
	'sf_createform_before' => 'ઢાંચા પહેલા:',
...
l'\\ URL dovrebbe risultare una cosa di questo tipo 'Special:RunQuery/<form name>'.",
	...
	'sf_too_few_instances_error' => 'Ci devono essere almeno $1 istanze di questo modello.', # Fuzzy
	'sf_too_many_instances_error' => 'Ci devono essere non più di $1 istanze di questo modello.', # Fuzzy
...
Dat süüht dann esu us, wi <code>{{#special:RunQuery}}/''<Fomullaa_Name >''</code>.",
	...
	'sf_too_many_instances_error' => 'Mer künne nit mieh wi {{PLURAL:$1|eine Oproof|$1 Oproofe|keine Oproof}} vun dä Schablohn han.', # Fuzzy
...
$messages['lb'] = array(
	...
	'sf-preview-note' => 'Esou gesäit de Formulaire aus wann e benotzt gëtt:',
...
$messages['oc'] = array(
	...
	'sf_formedit_remove' => 'Levar', # Fuzzy
...
$messages['pms'] = array(
	...
	'sf_createform_additembeforesave' => 'A deuv gionté almanch në stamp a cost formolari-sì prima ëd podèj salvelo.',
...
a URL deve se parecer com 'Special:RunQuery/<form name>'.",
	...
	'sf_too_few_instances_error' => 'É preciso haver pelo menos {{PLURAL:$1|uma instância|$1 instâncias}} desta predefinição.', # Fuzzy
	'sf_too_many_instances_error' => 'Não pode haver mais de {{PLURAL:$1|uma instância|$1 instâncias}} desta predefinição.', # Fuzzy
