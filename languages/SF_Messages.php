...
it should look like \'Special:FormEdit?form=<form name>&target=<target page>\', or  \'Special:FormEdit/<form name>/<target page>\'.',
	...
	'sf_autoedit_notargetspecified'      => "No target article specified.",
	'sf_autoedit_noformfound'            => "No form specified.",
	'sf_autoedit_toomanyformsfound'      => "More than one form available for article.",
	'sf_autoedit_readonly'               => "The database is currently locked to modifications. Reason: $1",
	'sf_autoedit_nosemanticform'         => "Could not get form $2 for article $1. See [[{{#special:FormEdit}}/$2/$1]] for details.",
	'runquery'                           => 'Run query',
