...
$messages['he'] = array(
	...
	'sf_createtemplate_aggregationdesc' => 'כדי להציג בכל דף המשתמש בתבנית זו את כל הדפים המכילים מאפיין מסויים המצביע לדף זה, ציינו את המאפיין המתאים להלן:',
	...
	'sf_createclass_docu' => 'הזינו את כל הנתונים כאן ליצירת המאפיינים, התבנית הטופס והקטגוריה עבור מחלקה בודדת. לאפשרויות נוספות, השתמשו בדפים $1 במקום.',
...
אחרת, תועברו אל הטופס להוספת הדף.',
	...
	'sf_editdata_morethanoneform' => "'''אזהרה:''' יותר מטופס ברירת מחדל אחד מוגדרים לדף זה.",
...
על הכתובת להיות מהצורה 'Special:RunQuery/&lt;שם הטופס&gt;'.",
	...
	'sf_property_allowedvals' => 'הער{{PLURAL:$1|ך האפשרי למאפיין זה הוא|כים האפשריים למאפיין זה הם}}:',
...
אם דף בשם זה כבר קיים, תועברו אל טופס לעריכת הדף.",
	...
	'right-viewedittab' => 'צפייה בלשונית "עריכה" עבור דפים הניתנים לעריכה על ידי טופס',
